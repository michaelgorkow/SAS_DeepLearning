...
def func_social_distancing(image, _nObjects_, 
    ...
    func_image, map2d = calc_visualize(func_image,objs)
    ...
    ret, combined = cv2.imencode('.JPEG', combined)
    combined = combined.tobytes()
    return combined
